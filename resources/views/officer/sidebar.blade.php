<!-- officer/sidebar.blade.php -->
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Procurement Officer</h5>
                  <span>O.P</span>
                </div>
              </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('addAsset_view')}}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('assetMove_view')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
              <span class="menu-title">Asset Movement</span>
            </a>
          </li>
        </ul>
      </nav>
